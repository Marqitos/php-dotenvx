...
{
    const R_PHP_OPTION_LAZY_OPTION  = __DIR__ . '/LazyOption.php';
    const R_PHP_OPTION_NONE         = __DIR__ . '/None.php';
    const R_PHP_OPTION_SOME         = __DIR__ . '/Some.php';
    ...
    {
        if ($value === $noneValue) {
            require_once self::R_PHP_OPTION_NONE;
            return None::create();
        }

        require_once self::R_PHP_OPTION_SOME;
    ...
    *                             null by default.
    ...
    {
        require_once self::R_PHP_OPTION_LAZY_OPTION;
