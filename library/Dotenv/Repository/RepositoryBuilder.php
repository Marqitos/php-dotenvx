...
require_once __DIR__ . '/Adapter/EnvConstAdapter.php';
require_once __DIR__ . '/Adapter/ServerConstAdapter.php';

final class RepositoryBuilder
{
    const R_DOTENV_REPOSITORY_ADAPTER_INTERFACE = __DIR__ . '/Adapter/AdapterInterface.php';
    const R_DOTENV_REPOSITORY_ADAPTER_WRITER_INTERFACE = __DIR__ . '/Adapter/WriterInterface.php';
    /**
    ...
    private static function isAnAdapterClass(string $name)
    {
        ...
        require_once self::R_DOTENV_REPOSITORY_ADAPTER_INTERFACE;
    ...
    {
        require_once __DIR__ . '/Adapter/ReaderInterface.php';
    ...
    {
        require_once self::R_DOTENV_REPOSITORY_ADAPTER_WRITER_INTERFACE;
    ...
    {
        require_once __DIR__ . '/Adapter/MultiReader.php';
        require_once __DIR__ . '/Adapter/MultiWriter.php';
        $reader = new MultiReader($this->readers);
        $writer = new MultiWriter($this->writers);

        if ($this->immutable) {
            require_once __DIR__ . '/Adapter/ImmutableWriter.php';
            $writer = new ImmutableWriter($writer, $reader);
        }

        if ($this->allowList !== null) {
            require_once __DIR__ . '/Adapter/GuardedWriter.php';
            $writer = new GuardedWriter($writer, $this->allowList);
        }

        require_once __DIR__ . '/AdapterRepository.php';
