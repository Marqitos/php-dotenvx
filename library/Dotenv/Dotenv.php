...
require_once __DIR__ . '/Loader/LoaderInterface.php';
require_once __DIR__ . '/Parser/ParserInterface.php';
require_once __DIR__ . '/Repository/RepositoryInterface.php';
require_once __DIR__ . '/Store/StoreBuilder.php';
require_once __DIR__ . '/Store/StoreInterface.php';
require_once __DIR__ . '/Store/StringStore.php';

class Dotenv
{
    const R_DOVENT_VALIDATOR                    = __DIR__ . '/Validator.php';
    const R_DOVENT_LOADER_LOADER                = __DIR__ . '/Loader/Loader.php';
    const R_DOVENT_PARSER_PARSER                = __DIR__ . '/Parser/Parser.php';
    const R_DOVENT_REPOSITORY_ARRAY_ADAPTER     = __DIR__ . '/Repository/Adapter/ArrayAdapter.php';
    const R_DOVENT_REPOSITORY_PUTENV_ADAPTER    = __DIR__ . '/Repository/Adapter/PutenvAdapter.php';
    const R_DOVENT_REPOSITORY_BUILDER           = __DIR__ . '/Repository/RepositoryBuilder.php';
    ...
    {
        require_once self::R_DOVENT_LOADER_LOADER;
        require_once self::R_DOVENT_PARSER_PARSER;
    ...
    {
        require_once self::R_DOVENT_REPOSITORY_BUILDER;
    ...
    {
        require_once self::R_DOVENT_REPOSITORY_PUTENV_ADAPTER;
        require_once self::R_DOVENT_REPOSITORY_BUILDER;
    ...
    {
        require_once self::R_DOVENT_REPOSITORY_ARRAY_ADAPTER;
        require_once self::R_DOVENT_REPOSITORY_BUILDER;
    ...
    {
        require_once self::R_DOVENT_VALIDATOR;
