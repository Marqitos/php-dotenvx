...
require_once 'Dotenv/Loader/LoaderInterface.php';
require_once 'Dotenv/Parser/Parser.php';
require_once 'Dotenv/Parser/ParserInterface.php';
require_once 'Dotenv/Repository/RepositoryBuilder.php';
require_once 'Dotenv/Repository/RepositoryInterface.php';
require_once 'Dotenv/Store/StoreBuilder.php';
require_once 'Dotenv/Store/StoreInterface.php';
require_once 'Dotenv/Store/StringStore.php';
require_once 'Dotenv/Validator.php';
require_once __DIR__ . '/Adapter/ArrayAdapter.php';
...
class Dotenvx {
    ...
    public function loadEncrypted(callable $decryptor): array {
        require_once __DIR__ . '/Parser/EntriesExtensions.php';
        $entries = $this->parser->parse($this->store->read());
