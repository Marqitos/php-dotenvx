...
{
    const R_PARAGONIE_SODIUM_CORE_BASE64_ORIGINAL   = __DIR__ . '/Core/Base64/Original.php';
    const R_PARAGONIE_SODIUM_CORE_BASE64_URL_SAFE   = __DIR__ . '/Core/Base64/UrlSafe.php';
    const R_PARAGONIE_SODIUM_CRYPTO                 = __DIR__ . '/Crypto.php';
    const R_PARAGONIE_SODIUM_EXCEPTION              = __DIR__ . '/SodiumException.php';
    /**
    ...
    public static function base642bin(
        ...
        try {
            require_once self::R_PARAGONIE_SODIUM_CORE_BASE64_ORIGINAL;
            require_once self::R_PARAGONIE_SODIUM_CORE_BASE64_URL_SAFE;
            require_once self::R_PARAGONIE_SODIUM_EXCEPTION;
    ...
    public static function crypto_aead_chacha20poly1305_decrypt(
        ...
        require_once self::R_PARAGONIE_SODIUM_CRYPTO;
