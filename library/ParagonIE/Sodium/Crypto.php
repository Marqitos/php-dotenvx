...
{
    const R_PARAGONIE_SODIUM_CORE_X25519            = __DIR__ . '/Core/X25519.php';
    ...
    public static function generichash(
        ...
        require_once self::R_PARAGONIE_SODIUM_CORE_BLAKE2B;
    ...
    public static function scalarmult(
        ...
        require_once self::R_PARAGONIE_SODIUM_CORE_X25519;
