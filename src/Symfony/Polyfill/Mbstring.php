...
/*
 * This file is based on Mbstring.php, part of the Symfony package,
 * symfony/polyfill-mbstring from Fabien Potencier <fabien@symfony.com>.
 *
...
final class Mbstring
{
    ...
    {
        if (file_exists($file = __DIR__.'/Mbstring/Resources/unidata/'.$file.'.php')) {
            return require $file;
        }
